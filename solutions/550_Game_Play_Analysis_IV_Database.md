...
# 🗄️ 550. Game Play Analysis IV

*Pushed on August 09, 2026 · Problem #63 in my journey*
...
FROM Activity as A
JOIN (SELECT player_id,MIN(event_date) AS first_login FROM Activity GROUP BY player_id) AS F
